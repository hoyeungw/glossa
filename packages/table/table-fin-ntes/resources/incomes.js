export const incomes = {
  ...
  rows: [
    ...
    ['number', 116, 116, NaN, NaN, 'netCompensationExp'             , 'net compensation expenses'                           , '赔付支出净额'         ], 
    ...
    ['number', 129, 129, NaN, NaN, 'exchGain'                       , 'exchange gain'                                       , '汇兑收益'           ], 
    ...
    ['number', 141, 141, 115, 115, 'netInc'                         , 'net income'                                          , '净利润'            ], 
    ['number', 142, 142, NaN, NaN, 'netIncAttrParentCompanyOwner'   , 'net income attributable to parent company owner'     , '归属于母公司所有者的净利润'  ], 
    ['number', 143, 143, NaN, NaN, 'netIncOfMergedPartyBeforeMerger', 'net income of the merged party before the merger '   , '被合并方在合并前实现净利润'  ], 
