...
const TableCollection = {
  ...
  get enterpriseValues() {
    return Table.from(enterpriseValues);
  }

};

export { TableCollection, balances, cashflows, enterpriseValues, incomes };
