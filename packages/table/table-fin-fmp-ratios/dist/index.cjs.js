...
const TableCollection = {
  get cashflow() {
    ...
    return _cashflow = cashflow, table.Table.from(_cashflow);
  },

  get liability() {
    var _liability;

    return _liability = liability, table.Table.from(_liability);
  },

  get liquidity() {
    var _liquidity;

    return _liquidity = liquidity, table.Table.from(_liquidity);
  },

  get operation() {
    var _operation;

    return _operation = operation, table.Table.from(_operation);
  },

  get profitability() {
    var _profitability;

    return _profitability = profitability, table.Table.from(_profitability);
  },

  get valuation() {
    var _valuation;

    return _valuation = valuation, table.Table.from(_valuation);
  },
