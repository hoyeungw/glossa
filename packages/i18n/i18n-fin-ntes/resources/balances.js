export const balances = [
  ...
  ['预付款项', 'prepayments'],
  ['应收保费', 'premium receivables'],
  ['应收分保账款', 'reinsurance accounts receivables'],
  ['应收分保合同准备金', 'reinsurance contract reserve receivables'],
  ['应收利息', 'interest receivables'],
  ['应收股利', 'dividends receivables'],
  ['其他应收款', 'other receivables'],
  ['应收出口退税', 'export tax refund receivables'],
  ['应收补贴款', 'subsidies receivables'],
  ['应收保证金', 'margin receivables'],
  ...
  ['发放贷款及垫款', 'loans and advances to customers'],
  ...
  ['拆入资金', 'borrowed funds'],
  ['交易性金融负债', 'transactional financial liabilities'],
  ...
  ['应付分保账款', 'reinsurance premiums payable'],
  ['保险合同准备金', 'insurance contract reserves'],
  ['代理买卖证券款', 'customer brokerage deposits'],
  ['代理承销证券款', 'securities underwriting brokerage deposits'],
