...
const DictCollection = {
  ...
  get balances() {
    ...
    return _merge = merge(generals, balances), makeReplaceable(_merge);
  },

  get incomes() {
    var _merge2;

    return _merge2 = merge(generals, incomes), makeReplaceable(_merge2);
  },

  get cashflows() {
    var _merge3;

    return _merge3 = merge(generals, cashflows), makeReplaceable(_merge3);
  },

  get basics() {
    var _merge4;

    return _merge4 = merge(generals, basics), makeReplaceable(_merge4);
  },

  get enterpriseValues() {
    var _merge5;

    return _merge5 = merge(generals, enterpriseValues), makeReplaceable(_merge5);
  },
...
export { DictCollection, balances, basics, cashflows, enterpriseValues, generals, incomes };
