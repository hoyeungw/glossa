...
const cashflows = [[/depreciation/gi, 'deprec'], [/cash flow/gi, 'cf'], [/subtotal of cash inflow from/gi, 'cash-in'], [/subtotal of cash outflow from/gi, 'cash-out'], [/increase (in|of)/gi, 'incr'], [/decrease (in|of)/gi, 'decr'], [/equivalents/gi, 'eqv'], [/amortization/gi, 'amort'], [/activities/gi, '']];
