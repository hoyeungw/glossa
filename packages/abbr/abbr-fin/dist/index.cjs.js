...
const DictCollection = {
  get generals() {
    ...
    return _merge = vectorMerge.merge(grammatic, generals), makeReplaceable(_merge);
  },

  get balances() {
    var _merge2;

    return _merge2 = vectorMerge.merge(grammatic, generals, balances), makeReplaceable(_merge2);
  },

  get incomes() {
    var _merge3;

    return _merge3 = vectorMerge.merge(grammatic, generals, incomes), makeReplaceable(_merge3);
  },

  get cashflows() {
    var _merge4;

    return _merge4 = vectorMerge.merge(grammatic, generals, cashflows), makeReplaceable(_merge4);
  },

  get basics() {
    var _merge5;

    return _merge5 = vectorMerge.merge(grammatic, generals, basics), makeReplaceable(_merge5);
  },

  get enterpriseValues() {
    var _merge6;

    return _merge6 = vectorMerge.merge(grammatic, generals, enterpriseValues), makeReplaceable(_merge6);
  },
...
const Abbr = (...topics) => {
  let dict = vectorMerge.merges(grammatic, generals);
